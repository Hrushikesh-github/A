...
classNames = [pt.split("/")[-2] for pt in imagePaths]
...
# loop over all layers in base model and freeze them so they will
...
# (with all other layers frozen) -- this will allow the new FC layers to
# start to become initialized with actual "learned" values versus pure 
# random
